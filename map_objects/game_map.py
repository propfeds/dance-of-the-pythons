...
class GameMap:
    def __init__(self, width, height):
        ...
        x_origin=3
        # Dirt paths
        x_dest=generator.cave_y(x_origin, 0, self.height-6, Tile('•', (138, 111, 48), (82, 75, 36)), 50, 50, 1, 1, 3, self)
        x_dest=generator.cave_y(x_origin, 0, self.height-1, Tile('•', (138, 111, 48), (82, 75, 36)), 100, 100, 1, 0, 2, self)
        # Dirt walls
